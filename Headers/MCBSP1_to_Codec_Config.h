/*
 * MCBSP!_to_Codec_Config.h
 *
 *  Created on: 26/05/2018
 *      Author: JuaniPC
 */

#ifndef MCBSP__TO_CODEC_CONFIG_H_
#define MCBSP__TO_CODEC_CONFIG_H_

// This is needed to modify the BSL's data channel McBSP configuration
// See the changes below
MCBSP_Config MCBSP1_to_Codec_Config = {
...
#endif /* MCBSP__TO_CODEC_CONFIG_H_ */
